...
<title>Reject Manufacture Order</title>
</head>
...
if($OPENING)
	...
	//SELECT NEW LINEITEM
	  $sql = "SELECT P.ProductCode,ProductName,Price,QuantityOut,TotalPrice,ManufactureOrder	 FROM InventoryLine I JOIN Product P ON I.ProductCode = P.ProductCode WHERE StockNo ='".$StockNo."'";
	  $result=mysql_query($sql);
	  //GET DATA
	...
	{ 
		if(ISSET($_SESSION['StockNo']))
		{
			...
			$_SESSION['Reason'] = "Reject Manufacture Order";
	}
	if($_SESSION['StockNo']=="NEW")
	{
		$Reason = "Reject Manufacture Order";
...
<form id="form1" name="form1" method="post" action="">
  <h1>Reject Manufacture Order</h1>
  <p>
    <input type="button" value="NEW" onClick="window.location = 'clearMR.php'" />
    <input type="submit" value="SAVE" formaction = "saveMR.php" formmethod = "get" formtarget = "_blank"/>
    <input type="submit" name="btnOpen" id="btnOpen" value="OPEN" onClick="window.open('ListofStockMR.php','popup','width=610,height=500,scrollbars');"/>
    <input type="submit" value="DELETE" formaction="deleteMR.php" formmethod="get" formtarget="_blank" />
  ...
  <table width="960" border="0">
    <tr>
      ...
      <td width="169"><label for="txtStockNo"></label>
    ...
    <tr>
      ...
      <input name="txtReason" style=" width:155px;"type="text"class="bg" id="txtReason" value="<?=$Reason?>" readonly = "true" /></td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><input type="submit" name="btnWarehouse" id="btnWarehouse" value="..." onClick="window.open('ListWarehouseMR.php','popup','width=610,height=500,scrollbars');" /></td>
      <td>Warehouse Name :
    ...
    <tr>
      <td height="55">Warehouse Phone :</td>
...
<form name="form2" id="form2" method="post" >
  ...
  <th width="75" scope="col"></th>
      ...
      <th width="193" scope="col"><font color ="red">*</font>Quantity Out</th>
  ...
  $NoRow=1;
    ...
    <tr>
      ...
      <td align="center"><input name="EditQuantityOut" style="text-align:right; width:120px;" type="text" id="EditQuantityOut"  value="<?=$EditQuantityOut?>"size="10"  "/>
      </td>
...
?>
  ...
  ?>
    ...
    <tr>
      ...
      <input type="submit" name="btnProduct" id="btnProduct" value="..." onClick="window.open('ListProductMR.php','popup','width=610,height=500,scrollbars');"/></td>
      ...
      <input name="txtQuantity" style="text-align:right;" type="text" id="txtQuantity" value="<?=$QuantityOut?>"  onkeyup="checkError('txtQuantity');" " /></td>
