...
<form name="form1" id="form1" method="post" action="pdfGen.php" target="_self">
  ...
  <tr>
    <th width="100" scope="col"><table width="730" border="0">
      <tr>
        <th width="62" scope="col"><table width="730" border="0">
          <tr>
            <th colspan="7" scope="col"><div align="justify">
              <p><span class="style9">
          ...
          <tr>
            ...
            <th width="153" scope="col"><div align="left" class="style8 style7">
              <label for="txtRPStockNo"></label>
              <input name="txtRPStockNo" type="text" id="txtRPStockNo" value="<?=$Stock?>"  />
            </div></th>
            <th width="62" scope="col"><span class="style5">
              <input name="btnStck" type="button" id="btnStock" value="..." onclick="window.open('ListStockMOReport.php','popup','width=650,height=500,scrollbars');" />
              </span>
  ...
  <tr>
    <th scope="col"><div align="left" class="style5"><strong>Stock No : </strong></div></th>
    <th scope="col"><div align="left" class="style8 style7">
      <label for="txtRPStockNo"></label>
      <input name="txtRPStockNo" type="text" id="txtRPStockNo" value="<?=$Stock?>"  />
    </div></th>
  ...
  <tr>
    ...
    <th width="153" scope="col"><div align="left" class="style8 style7"><strong>
      <select name="month">
    ...
    <th width="62" scope="col"><div align="left" class="style5"><strong>Between</strong></div></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><div align="left"></div></td>
    <td width="99"><div align="left"></div></td>
  </tr>
  <tr></tr>
  <tr>
    <td><div align="left">
