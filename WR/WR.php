...
if($OPENING)
	...
	//SELECT NEW LINEITEM
	  $sql = "SELECT P.ProductCode,ProductName,Price,QuantityOut,TotalPrice,WorkOrder FROM InventoryLine I JOIN Product P ON I.ProductCode = P.ProductCode WHERE StockNo ='".$StockNo."'";
	  $result=mysql_query($sql);
	  //GET DATA
...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>
    <input type="button" value="NEW" onClick="window.location = 'clearWR.php'" />
    <input type="submit" value="SAVE" formaction = "saveWR.php" formmethod = "get" formtarget = "_blank"/>
    <input type="submit" name="btnOpen" id="btnOpen" value="OPEN" onClick="window.open('ListofStockWR.php','popup','width=610,height=500,scrollbars');"/>
    <input type="submit" value="DELETE" formaction="deleteWR.php" formmethod="get" formtarget="_blank" />
  ...
  <table width="960" border="0">
    ...
    <tr>
      ...
      <td><input type="submit" name="btnCustomer" id="btnCustomer" value="..." onClick="window.open('ListSupplierWR.php','popup','width=610,height=500,scrollbars');" /></td>
      <td>Supplier Name :
    ...
    <tr>
      ...
      <td><input type="submit" name="btnWarehouse" id="btnWarehouse" value="..." onClick="window.open('ListWarehouseWR.php','popup','width=610,height=500,scrollbars');" /></td>
      <td>Warehouse Name :
...
?>
  ...
  ?>
    ...
    <tr>
      ...
      <input type="submit" name="btnProduct" id="btnProduct" value="..." onClick="window.open('ListProductWR.php','popup','width=610,height=500,scrollbars');"/></td>
