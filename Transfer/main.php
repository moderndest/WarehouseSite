...
<!--------------- add button -------------->
<label><div align="left"><span class="style7">TRANSFER IN / OUT</span></div></label>
      ...
      <div align="left">
		...
		?>
            ...
            <option value ="select">Select</option>
				...
				$sql= "SELECT Reason FROM reason WHERE Reason like('%Tr%')";
...
<?php
  ...
  <tr>
   <td>&nbsp;</td>
    ...
    <td align= center>
	<input name="txtQuantityIn"  type="text" style="text-align:right; width:80px;" id="txtQuantityIn" value="<?=$QuantityIn?>" onkeyup="checkError('txtQuantityIn');" <?php if($selected == "Transfer out" || $selected == "select") echo 'class = "bg" readonly="readonly"' ; ?>/></td>
          
    <td align= center><label for="txtQuantityOut"></label>
      <input  name="txtQuantityOut" type="text" id="txtQuantityOut" style="text-align:right; width:80px;" value="<?=$QuantityOut?>" onkeyup="checkError('txtQuantityOut');" <?php if($selected == "Transfer in" || $selected == "select") echo 'class = "bg" readonly="readonly"'; ?>/></td>
