...
function calculateprice(){
	document.form2.txtTotalPrice.value = (document.form2.txtQuantityIn.value * document.form2.txtUnitPrice.value).toFixed(2);	
}
...
<?php
/*if((isset($_REQUEST['txtStockNo']))&&($open==1))
	{
	$_SESSION['StockNo']=$_REQUEST['txtStockNo'];
	}
*/
/* ----------------- Open Invoice ------------------------ */
...
<form id="form1" name="form1" method="post" action="">
  <h1>Stock Issue In : Sales Return Reason</h1>
  <p>
  ...
  <table width="960" border="0">
    ...
    <tr>
      ...
      <input name="txtCustomerCode" type="text" id="txtCustomerCode" value="<?=$CustomerCode?>" readonly="readonly" required /></td>
...
<form name="form2" id="form2" method="post" >
  ...
  <th width="60" scope="col"></th>
      ...
      <th width="125" scope="col"><font color ="red">*</font>Quantity In</th>
      ...
      if(isset( $_REQUEST['cmd']) && $_REQUEST['cmd']=='Update') 
{
	for ($i=0; $i<=10; $i++)
	{
		...
		{
			$_SESSION['LineItems'][$i]["QuantityIn"] = $_REQUEST['EditQuantityIn'];
  ...
  if(isset($_REQUEST['btnAdd']))
{
	...
	/*echo "<script language='javascript'>";
		echo "function redirect(){document.location=\"main.php\";} ";
  ...
  $NoRow=1;
    ...
    <td align="right">
      <input name="EditQuantityIn" type="text" id="EditQuantityIn" onchange="Editcalculateprice();" value="<?=$EditQuantityIn?>" size="5" /></td>
    <td align="right">
   ...
   $SOCode=$_REQUEST['txtSOCode'];	
    ...
    <td>&nbsp;</td>
     <td><input type="submit" name="btnAdd" id="btnAdd" value="ADD" /></td>
      ...
      <input name="txtProductCode" type="text" id="txtProductCode" value="<?=$ProductCode?>" readonly="readonly" />
	 ...
	 ?>
      ...
      <input name="txtQuantityIn" type="text" id="txtQuantityIn" value="<?=$QuantityIn?>" onchange="calculateprice();" required /></td>
      ...
      <input name="txtSOCode" type="text" id="txtSOCode" value="<?=$SOCode?>" onchange="storeData();" required />
      <input type="submit" name="btnSOCode" id="btnSOCode" value="..."  onclick="window.open('ListSOHead.php','popup','width=300,height=500,scrollbars');"/></td>
    </tr>
  </table>
