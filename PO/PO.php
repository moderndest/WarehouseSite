...
function disable(id){
  ...
  x.style.backgroundColor='#c0c0c0';
	...
	function getProduct() 
	{
		...
		window.location = "PO.php?P="+ProductCode;
	}
	function getInvoice() 
	{
		var StockNo = document.getElementById("StockNo").value;
		window.location = "PO.php?StockNo="+StockNo;
	}
	...
	function getPO() 
	{
		...
		window.location = "PO.php?PONo="+PONo;
	}
...
if($OPENING)
	...
	//SELECT NEW LINEITEM
	  $sql = "SELECT P.ProductCode,ProductName,Price,QuantityIn,TotalPrice,PurchaseOrder FROM InventoryLine I JOIN Product P ON I.ProductCode = P.ProductCode WHERE StockNo ='".$StockNo."'";
	  $result=mysql_query($sql);
	  //GET DATA
	...
	{ 
		if(ISSET($_SESSION['StockNo']))
		{
			...
			$_SESSION['Reason'] = "Purchase Order";
	}
...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>
    <input type="button" value="NEW" onClick="window.location = 'clearPO.php'" />
    <input type="submit" value="SAVE" formaction = "savePO.php" formmethod = "get" formtarget = "_blank"/>
    <input type="submit" name="btnOpen" id="btnOpen" value="OPEN" onClick="window.open('ListofStockPO.php','popup','width=610,height=500,scrollbars');"/>
    <input type="submit" value="DELETE" formaction="deletePO.php" formmethod="get" formtarget="_blank" />
  ...
  <table width="960" border="0">
    ...
    <tr>
      ...
      <td><input type="submit" name="btnCustomer" id="btnCustomer" value="..." onClick="window.open('ListSupplierPO.php','popup','width=610,height=500,scrollbars');" /></td>
      <td>Supplier Name :
    ...
    <tr>
      ...
      <td><input type="submit" name="btnWarehouse" id="btnWarehouse" value="..." onClick="window.open('ListWarehousePO.php','popup','width=610,height=500,scrollbars');" /></td>
      <td>Warehouse Name :
...
?>
  ...
  ?>
    ...
    <tr>
      ...
      <input type="submit" name="btnProduct" id="btnProduct" value="..." onClick="window.open('ListProductPO.php','popup','width=610,height=500,scrollbars');"/></td>
      ...
      <td><label for="PONo"></label>
        <input name="PONo" style="text-align:center;"type="text" id="PONo" value="<?=$PONo?>"onChange="getPO(); "/>
